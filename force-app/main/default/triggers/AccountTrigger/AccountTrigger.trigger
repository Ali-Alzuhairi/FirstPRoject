Trigger AccountTrigger on Account( before insert, after insert,
  ...
  if (Trigger.isAfter && Trigger.isInsert) {
    ...
    // We are about to insert contacts for each Account entered the trigger, so we need a List<Contact> to store it and eventually insert this using DML outside the loop 
